...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  // match the entered password from user collection
  // set new Password and Save it in mongoDB
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Cover Image file is updated."));
});

const getUserChannelProfile = asyncHandler(async (req, res) => {
  // get username from requested parameters
  // validate user in requested parameters
  // get user from mongodb by applying aggregation pipelines
  // check channel length and throw error
...
const getWatchHistory = asyncHandler(async (req, res) => {
  // get document from collection by writing aggregation pipelines
